...
export const HeroSection: React.FC<HeroSectionProps> = ({ onScrollToOffer }) => {
  const handleKeyTap = (keyIndex: number) => {
    pianoSynth.playKey(keyIndex, 0.9);
  };
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center mb-8 lg:mb-12">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left z-10">
            ...
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-1.5 rounded-full bg-[#161821] border border-[#272a38] text-[11px] sm:text-xs font-semibold text-zinc-300 mb-5 shadow-sm max-w-full flex-wrap">
              ...
              <span className="text-zinc-200 truncate sm:overflow-visible">Gravação Sincronizada 4K</span>
              <span className="text-zinc-500">•</span>
              <span className="text-[#00f2c3]">Versão Oficial 2026</span>
            </div>
            ...
            >
              Grave <span className="text-white font-semibold">100% no celular com timbres próprios (.SF2)</span> sem DAW, ou conecte <span className="text-[#00f2c3] font-semibold">sem fios ao PC via QR Code</span> com sincronização de vídeos do YouTube e personalização total.
            </p>
            ...
            >
              ...
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#131722] border border-[#00f2c3]/30 text-xs text-[#00f2c3] shadow-sm font-medium">
                ...
                <span>Timbres .SF2 Próprios</span>
              </div>
              ...
              <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#18131d] border border-purple-500/30 text-xs text-purple-300 shadow-sm font-medium">
                <span>QR Code Wi-Fi &amp; YouTube Sync</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto mb-6">
              ...
              >
                ...
                <span>Adquirir MIDI Cam - R$ 24,90</span>
              </button>
            ...
            <div className="flex items-center gap-2.5 text-xs text-zinc-400 font-medium">
              ...
              <span>Conexão direta USB-MIDI e WI-FI. Sem necessidade de computador.</span>
            </div>

          </div>

          {/* RIGHT COLUMN: Official Product Identity Showcase (Clean, No chord engine) */}
          <div className="lg:col-span-5 flex flex-col items-center justify-center z-10">
            <div className="w-full max-w-[440px] relative">
              ...
              >
                ...
                {/* Center Official Large Icon (180x180px requirement) */}
                <div className="flex flex-col items-center justify-center pt-2 pb-2 my-2">
                  <div className="relative group">
                    {/* Official Squircle Icon 180x180px with subtle relief and cyan light reflection */}
                ...
                <div className="mt-5 p-4 rounded-2xl bg-[#09090c] border border-[#1f212d] space-y-2 text-xs">
                  <div className="flex items-center justify-between font-mono">
                    <span className="text-zinc-400">Sincronismo Áudio + MIDI</span>
                  ...
                  <div className="flex items-center justify-between font-mono">
                    <span className="text-zinc-400">Timbres Próprios</span>
                  ...
                  <div className="flex items-center justify-between font-mono">
                    <span className="text-zinc-400">Conexão Sem Fio</span>
                    <span className="text-zinc-200">QR Code Wi-Fi (App PC)</span>
                  </div>

                  <div className="flex items-center justify-between font-mono">
                    <span className="text-zinc-400">Integração YouTube</span>
                    <span className="text-red-400 font-semibold">Playbacks Sincronizados</span>
                  </div>

                  <div className="flex items-center justify-between font-mono">
                    <span className="text-zinc-400">Personalização</span>
                    <span className="text-zinc-200">Cores, Teclados &amp; Filtros</span>
                  </div>

                  <div className="flex items-center justify-between font-mono pt-1 border-t border-zinc-800/80">
                    <span className="text-zinc-400">Exportação</span>
                    <span className="text-[#00f2c3] font-bold">1 Clique para a Galeria</span>
                  </div>
                </div>
                ...
                <div className="mt-3.5 flex items-center justify-between text-[11px] text-zinc-400 px-1">
                  <span className="flex items-center gap-1.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#00f2c3]" />
                    Celular Autônomo ou PC Sem Fio
                  </span>
        ...
        {/* BOTTOM SECTION: CAROUSEL EXACTLY AS SHOWN IN EXAMPLE IMAGE (Right below CTA) */}
